...
randDANvs <- analysis_random_graphs(gDANvs, kNumRand, savedir = outdir1,
                                      clustering = clustering)

randDANt0 <- analysis_random_graphs(gDANt0, kNumRand, savedir = outdir2,
                                      clustering = clustering)

randDANt1 <- analysis_random_graphs(gDANt1, kNumRand, savedir = outdir3,
                                      clustering = clustering)

randDANtx0 <- analysis_random_graphs(gDANtx0, kNumRand, savedir = outdir4,
                                       clustering = clustering)

randDANtx1 <- analysis_random_graphs(gDANtx1, kNumRand, savedir = outdir5,
                                       clustering = clustering)

randDANl0 <- analysis_random_graphs(gDANl0, kNumRand, savedir = outdir6,
                                      clustering = clustering)

randDANl1 <- analysis_random_graphs(gDANl1, kNumRand, savedir = outdir7,
                                      clustering = clustering)

randDANl2 <- analysis_random_graphs(gDANl2, kNumRand, savedir = outdir8,
                                      clustering = clustering)
