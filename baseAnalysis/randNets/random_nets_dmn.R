...
# randDMNvs <- analysis_random_graphs(
#     gDMNvs, kNumRand, savedir = outdir1,
#     clustering = clustering
# )

randDMNt0 <- analysis_random_graphs(
    gDMNt0, kNumRand, savedir = outdir2,
    clustering = clustering
)

randDMNt1 <- analysis_random_graphs(
    gDMNt1, kNumRand, savedir = outdir3,
    clustering = clustering
)

# randDMNtx0 <- analysis_random_graphs(
#     gDMNtx0, kNumRand, savedir = outdir4,
#     clustering = clustering
# )
# 
# randDMNtx1 <- analysis_random_graphs(
#     gDMNtx1, kNumRand, savedir = outdir5,
#     clustering = clustering
# )
# 
# randDMNl0 <- analysis_random_graphs(
#     gDMNl0, kNumRand, savedir = outdir6,
#     clustering = clustering
# )
# 
# randDMNl1 <- analysis_random_graphs(
#     gDMNl1, kNumRand, savedir = outdir7,
#     clustering = clustering
# )
# 
# randDMNl2 <- analysis_random_graphs(
#     gDMNl2, kNumRand, savedir = outdir8,
#     clustering = clustering
# )
