...
# randVANvs <- analysis_random_graphs(gVANvs, kNumRand, savedir = outdir1,
#                                       clustering = clustering)

randVANt0 <- analysis_random_graphs(gVANt0, kNumRand, savedir = outdir2,
                                      clustering = clustering)

randVANt1 <- analysis_random_graphs(gVANt1, kNumRand, savedir = outdir3,
                                      clustering = clustering)

randVANtx0 <- analysis_random_graphs(gVANtx0, kNumRand, savedir = outdir4,
                                       clustering = clustering)

randVANtx1 <- analysis_random_graphs(gVANtx1, kNumRand, savedir = outdir5,
                                       clustering = clustering)

randVANl0 <- analysis_random_graphs(gVANl0, kNumRand, savedir = outdir6,
                                      clustering = clustering)

randVANl1 <- analysis_random_graphs(gVANl1, kNumRand, savedir = outdir7,
                                      clustering = clustering)

randVANl2 <- analysis_random_graphs(gVANl2, kNumRand, savedir = outdir8,
                                      clustering = clustering)
