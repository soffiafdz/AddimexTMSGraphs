...
```{r gordon-dens-gs}
dt.main  <- dt.all[a == "gordon333" & t.m == "dens" & gs == "gs",
                   -c("a", "t.m", "gs")]
```
...
```{r repmesl-density, fig.cap = "Integrated metric of density by session."}
...
```{r lmerl-density, eval = F, results = "asis"}
...
```{r repmesl-strength, fig.cap = "Integrated metric of strength by session."}
...
```{r lmerl-strength, eval = F, results = "asis"}
...
```{r repmesl-mod, fig.cap = "Integrated metric of modularity by session."}
...
```{r lmerl-mod, eval = F, results = "asis"}
...
```{r repmesl-hubs, fig.cap = "Integrated metric of number of hubs by session."}
...
```{r lmerl-nhubs, eval = F, results = "asis"}
...
```{r repmesl-eglob, fig.cap = "Integrated metric of global efficiency by session."}
...
```{r lmerl-eglob, eval = F, results = "asis"}
...
```{r repmesl-eglobw, fig.cap = "Integrated metric of global efficiency (weighted) by session."}
...
```{r lmerl-eglobw, eval = F, results = "asis"}
...
```{r repmesl-eloc, fig.cap = "Integrated metric of local efficiency by session."}
...
```{r lmerl-eloc, eval = F, results = "asis"}
...
```{r repmesl-elocw, fig.cap = "Integrated metric of local efficiency (weighted) by session."}
