...
```{r dgn}
dt.main  <- dt.all[a == "gordon333" & t.m == "dens" & gs == "ngs",
                   -c("a", "t.m", "gs")]
```

### Acute phase

```{r dgn-sparklines-acute, fig.cap = "Sparklines of the topology metrics across thresholds. Labels: Max and Min; Grey shadow: IQR.", fig.height = 9}
...
```{r dgn-repmes-density, fig.cap = "Integrated metric of density by group."}
...
```{r dgn-lmer-density, results = "asis"}
...
```{r dgn-repmes-strength, fig.cap = "Integrated metric of strength by group."}
...
```{r dgn-lmer-strength, results = "asis"}
...
```{r dgn-repmes-mod, fig.cap = "Integrated metric of modularity by group."}
mod2x2 <- dt.integrals[,
...
```{r dgn-repmes-nhubs, fig.cap = "Integrated metric of the number of hubs by group."}
...
```{r dgn-repmes-eglob, fig.cap = "Integrated metric of global efficiency by group."}
...
```{r dgn-repmes-eglobw, fig.cap = "Integrated metric of global efficiency by group (weighted)."}
...
```{r dgn-lmer-eglobw, results = "asis"}
...
```{r dgn-repmes-eloc, fig.cap = "Integrated metric of local efficiency by group."}
...
```{r dgn-repmes-elocw, fig.cap = "Integrated metric of local efficicency (weighted) by group."}
...
```{r dgn-sparklines-long, fig.cap = "Sparklines of the topology metrics across thresholds in the maintenance phase. Labels: Max and Min; Grey shadow: IQR.", fig.height = 9}
# Reshape to Long
columns <- c(dems, "t", metrics)
...
```{r dgn-repmesl-density, fig.cap = "Integrated metric of density by session."}
...
```{r dgn-lmerl-density, eval = F, results = "asis"}
...
```{r dgn-repmesl-strength, fig.cap = "Integrated metric of strength by session."}
...
```{r dgn-lmerl-strength, eval = F, results = "asis"}
...
```{r dgn-repmesl-mod, fig.cap = "Integrated metric of modularity by session."}
...
```{r dgn-lmerl-mod, eval = F, results = "asis"}
...
```{r dgn-repmesl-hubs, fig.cap = "Integrated metric of number of hubs by session."}
...
```{r dgn-lmerl-nhubs, eval = F, results = "asis"}
...
```{r dgn-repmesl-eglob, fig.cap = "Integrated metric of global efficiency by session."}
...
```{r dgn-lmerl-eglob, eval = F, results = "asis"}
...
```{r dgn-repmesl-eglobw, fig.cap = "Integrated metric of global efficiency (weighted) by session."}
...
```{r dgn-lmerl-eglobw, eval = F, results = "asis"}
...
```{r dgn-repmesl-eloc, fig.cap = "Integrated metric of local efficiency by session."}
...
```{r dgn-lmerl-eloc, eval = F, results = "asis"}
...
```{r dgn-repmesl-elocw, fig.cap = "Integrated metric of local efficiency (weighted) by session."}
...
```{r dgn-lmerl-elocw, eval = F, results = "asis"}
