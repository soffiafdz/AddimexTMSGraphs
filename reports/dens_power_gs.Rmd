...
```{r dpg}
dt.main  <- dt.all[a == "power264" & t.m == "dens" & gs == "gs",
                   -c("a", "t.m", "gs")]
```

### Acute phase

```{r dpg-sparklines-acute, fig.cap = "Sparklines of the topology metrics across thresholds. Labels: Max and Min; Grey shadow: IQR.", fig.height = 9}
...
```{r dpg-repmes-density, fig.cap = "Integrated metric of density by group."}
...
```{r dpg-lmer-density, results = "asis"}
...
```{r dpg-repmes-strength, fig.cap = "Integrated metric of strength by group."}
...
```{r dpg-lmer-strength, results = "asis"}
...
```{r dpg-repmes-mod, fig.cap = "Integrated metric of modularity by group."}
mod2x2 <- dt.integrals[,
...
```{r dpg-repmes-nhubs, fig.cap = "Integrated metric of the number of hubs by group."}
...
```{r dpg-repmes-eglob, fig.cap = "Integrated metric of global efficiency by group."}
...
```{r dpg-repmes-eglobw, fig.cap = "Integrated metric of global efficiency by group (weighted)."}
...
```{r dpg-lmer-eglobw, results = "asis"}
...
```{r dpg-repmes-eloc, fig.cap = "Integrated metric of local efficiency by group."}
...
```{r dpg-repmes-elocw, fig.cap = "Integrated metric of local efficicency (weighted) by group."}
...
```{r dpg-sparklines-long, fig.cap = "Sparklines of the topology metrics across thresholds in the maintenance phase. Labels: Max and Min; Grey shadow: IQR.", fig.height = 9}
#Reshape to Long
columns <- c(dems, "t", metrics)
...
```{r dpg-repmesl-density, fig.cap = "Integrated metric of density by session."}
...
```{r dpg-lmerl-density, eval = F, results = "asis"}
...
```{r dpg-repmesl-strength, fig.cap = "Integrated metric of strength by session."}
...
```{r dpg-lmerl-strength, eval = F, results = "asis"}
...
```{r dpg-repmesl-mod, fig.cap = "Integrated metric of modularity by session."}
...
```{r dpg-lmerl-mod, eval = F, results = "asis"}
...
```{r dpg-repmesl-hubs, fig.cap = "Integrated metric of number of hubs by session."}
...
```{r dpg-lmerl-nhubs, eval = F, results = "asis"}
...
```{r dpg-repmesl-eglob, fig.cap = "Integrated metric of global efficiency by session."}
...
```{r dpg-lmerl-eglob, eval = F, results = "asis"}
...
```{r dpg-repmesl-eglobw, fig.cap = "Integrated metric of global efficiency (weighted) by session."}
...
```{r dpg-lmerl-eglobw, eval = F, results = "asis"}
...
```{r dpg-repmesl-eloc, fig.cap = "Integrated metric of local efficiency by session."}
...
```{r dpg-lmerl-eloc, eval = F, results = "asis"}
...
```{r dpg-repmesl-elocw, fig.cap = "Integrated metric of local efficiency (weighted) by session."}
...
```{r dpg-lmerl-elocw, eval = F, results = "asis"}
