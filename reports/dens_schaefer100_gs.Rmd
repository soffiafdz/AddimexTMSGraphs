...
```{r ds1g}
dt.main  <- dt.all[a == "schaefer100x7" & t.m == "dens" & gs == "gs",
                   -c("a", "t.m", "gs")]
```

### Acute phase

```{r ds1g-sparklines-acute, fig.cap = "Sparklines of the topology metrics across thresholds. Labels: Max and Min; Grey shadow: IQR.", fig.height = 9}
...
```{r ds1g-repmes-density, fig.cap = "Integrated metric of density by group."}
...
```{r ds1g-lmer-density, results = "asis"}
...
```{r ds1g-repmes-strength, fig.cap = "Integrated metric of strength by group."}
...
```{r ds1g-lmer-strength, results = "asis"}
...
```{r ds1g-repmes-mod, fig.cap = "Integrated metric of modularity by group."}
mod2x2 <- dt.integrals[,
...
```{r ds1g-repmes-nhubs, fig.cap = "Integrated metric of the number of hubs by group."}
...
```{r ds1g-lmer-nhubs, results = 'asis'}
...
```{r ds1g-repmes-eglob, fig.cap = "Integrated metric of global efficiency by group."}
...
```{r ds1g-lmer-eglob, results = "asis"}
...
```{r ds1g-repmes-eglobw, fig.cap = "Integrated metric of global efficiency by group (weighted)."}
...
```{r ds1g-lmer-eglobw, results = "asis"}
...
```{r ds1g-repmes-eloc, fig.cap = "Integrated metric of local efficiency by group."}
...
```{r ds1g-repmes-elocw, fig.cap = "Integrated metric of local efficicency (weighted) by group."}
...
```{r ds1g-lmer-elocw, results= "asis"}
...
```{r ds1g-sparklines-long, fig.cap = "Sparklines of the topology metrics across thresholds in the maintenance phase. Labels: Max and Min; Grey shadow: IQR.", fig.height = 9}
#Reshape to Long
columns <- c(dems, "t", metrics)
...
```{r ds1g-repmesl-density, fig.cap = "Integrated metric of density by session."}
...
```{r ds1g-lmerl-density, eval = F, results = "asis"}
...
```{r ds1g-repmesl-strength, fig.cap = "Integrated metric of strength by session."}
...
```{r ds1g-lmerl-strength, eval = F, results = "asis"}
...
```{r ds1g-repmesl-mod, fig.cap = "Integrated metric of modularity by session."}
...
```{r ds1g-lmerl-mod, eval = F, results = "asis"}
...
```{r ds1g-repmesl-hubs, fig.cap = "Integrated metric of number of hubs by session."}
...
```{r ds1g-lmerl-nhubs, eval = F, results = "asis"}
...
```{r ds1g-repmesl-eglob, fig.cap = "Integrated metric of global efficiency by session."}
...
```{r ds1g-lmerl-eglob, eval = F, results = "asis"}
...
```{r ds1g-repmesl-eglobw, fig.cap = "Integrated metric of global efficiency (weighted) by session."}
...
```{r ds1g-lmerl-eglobw, eval = F, results = "asis"}
...
```{r ds1g-repmesl-eloc, fig.cap = "Integrated metric of local efficiency by session."}
...
```{r ds1g-lmerl-eloc, eval = F, results = "asis"}
...
```{r ds1g-repmesl-elocw, fig.cap = "Integrated metric of local efficiency (weighted) by session."}
...
```{r ds1g-lmerl-elocw, eval = F, results = "asis"}
