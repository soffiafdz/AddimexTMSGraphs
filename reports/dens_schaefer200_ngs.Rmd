...
```{r ds2n}
dt.main  <- dt.all[a == "schaefer200x7" & t.m == "dens" & gs == "ngs",
                   -c("a", "t.m", "gs")]
```

### Acute phase

```{r ds2n-sparklines-acute, fig.cap = "Sparklines of the topology metrics across thresholds. Labels: Max and Min; Grey shadow: IQR.", fig.height = 9}
...
ggplot(dt.mean, aes(x = t, y = val, colour = session)) +
  ...
  ggtitle("Schaefer-200; Dens; noGS") +
...
```{r ds2n-repmes-density, fig.cap = "Integrated metric of density by group."}
...
```{r ds2n-lmer-density, results = "asis"}
...
```{r ds2n-repmes-strength, fig.cap = "Integrated metric of strength by group."}
...
```{r ds2n-lmer-strength, results = "asis"}
...
```{r ds2n-repmes-mod, fig.cap = "Integrated metric of modularity by group."}
mod2x2 <- dt.integrals[,
...
```{r ds2n-repmes-nhubs, fig.cap = "Integrated metric of the number of hubs by group."}
...
```{r ds2n-lmer-nhubs, results = 'asis'}
...
```{r ds2n-repmes-eglob, fig.cap = "Integrated metric of global efficiency by group."}
...
```{r ds2n-lmer-eglob, results = "asis"}
...
```{r ds2n-repmes-eglobw, fig.cap = "Integrated metric of global efficiency by group (weighted)."}
...
```{r ds2n-lmer-eglobw, results = "asis"}
...
```{r ds2n-repmes-eloc, fig.cap = "Integrated metric of local efficiency by group."}
...
```{r ds2n-repmes-elocw, fig.cap = "Integrated metric of local efficicency (weighted) by group."}
...
```{r ds2n-lmer-elocw, results= "asis"}
...
```{r ds2n-sparklines-long, fig.cap = "Sparklines of the topology metrics across thresholds in the maintenance phase. Labels: Max and Min; Grey shadow: IQR.", fig.height = 9}
# Reshape to Long
columns <- c(dems, "t", metrics)
...
```{r ds2n-repmesl-density, fig.cap = "Integrated metric of density by session."}
...
```{r ds2n-lmerl-density, eval = F, results = "asis"}
...
```{r ds2n-repmesl-strength, fig.cap = "Integrated metric of strength by session."}
...
```{r ds2n-lmerl-strength, eval = F, results = "asis"}
...
```{r ds2n-repmesl-mod, fig.cap = "Integrated metric of modularity by session."}
...
```{r ds2n-lmerl-mod, eval = F, results = "asis"}
...
```{r ds2n-repmesl-hubs, fig.cap = "Integrated metric of number of hubs by session."}
...
```{r ds2n-lmerl-nhubs, eval = F, results = "asis"}
...
```{r ds2n-repmesl-eglob, fig.cap = "Integrated metric of global efficiency by session."}
...
```{r ds2n-lmerl-eglob, eval = F, results = "asis"}
...
```{r ds2n-repmesl-eglobw, fig.cap = "Integrated metric of global efficiency (weighted) by session."}
...
```{r ds2n-lmerl-eglobw, eval = F, results = "asis"}
...
```{r ds2n-repmesl-eloc, fig.cap = "Integrated metric of local efficiency by session."}
...
```{r ds2n-lmerl-eloc, eval = F, results = "asis"}
...
```{r ds2n-repmesl-elocw, fig.cap = "Integrated metric of local efficiency (weighted) by session."}
...
```{r ds2n-lmerl-elocw, eval = F, results = "asis"}
