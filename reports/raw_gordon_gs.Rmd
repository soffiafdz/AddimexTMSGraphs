...
```{r rgg}
dt.main  <- dt.all[a == "gordon333" & t.m == "raw" & gs == "gs",
                   -c("a", "t.m", "gs")]
```

### Acute phase

```{r rgg-sparklines-acute, fig.cap = "Sparklines of the topology metrics across thresholds. Labels: Max and Min; Grey shadow: IQR.", fig.height = 9}
...
```{r rgg-repmes-density, fig.cap = "Integrated metric of density by group."}
...
```{r rgg-lmer-density, results = "asis"}
...
```{r rgg-repmes-strength, fig.cap = "Integrated metric of strength by group."}
...
```{r rgg-lmer-strength, results = "asis"}
...
```{r rgg-repmes-mod, fig.cap = "Integrated metric of modularity by group."}
mod2x2 <- dt.integrals[,
...
```{r rgg-repmes-nhubs, fig.cap = "Integrated metric of the number of hubs by group."}
...
```{r rgg-repmes-eglob, fig.cap = "Integrated metric of global efficiency by group."}
...
```{r rgg-repmes-eglobw, fig.cap = "Integrated metric of global efficiency by group (weighted)."}
...
```{r rgg-lmer-eglobw, results = "asis"}
...
```{r rgg-repmes-eloc, fig.cap = "Integrated metric of local efficiency by group."}
...
```{r rgg-repmes-elocw, fig.cap = "Integrated metric of local efficicency (weighted) by group."}
...
```{r rgg-sparklines-long, fig.cap = "Sparklines of the topology metrics across thresholds in the maintenance phase. Labels: Max and Min; Grey shadow: IQR.", fig.height = 9}
#Reshape to Long
columns <- c(dems, "t", metrics)
...
```{r rgg-repmesl-density, fig.cap = "Integrated metric of density by session."}
...
```{r rgg-lmerl-density, eval = F, results = "asis"}
...
```{r rgg-repmesl-strength, fig.cap = "Integrated metric of strength by session."}
...
```{r rgg-lmerl-strength, eval = F, results = "asis"}
...
```{r rgg-repmesl-mod, fig.cap = "Integrated metric of modularity by session."}
...
```{r rgg-lmerl-mod, eval = F, results = "asis"}
...
```{r rgg-repmesl-hubs, fig.cap = "Integrated metric of number of hubs by session."}
...
```{r rgg-lmerl-nhubs, eval = F, results = "asis"}
...
```{r rgg-repmesl-eglob, fig.cap = "Integrated metric of global efficiency by session."}
...
```{r rgg-lmerl-eglob, eval = F, results = "asis"}
...
```{r rgg-repmesl-eglobw, fig.cap = "Integrated metric of global efficiency (weighted) by session."}
...
```{r rgg-lmerl-eglobw, eval = F, results = "asis"}
...
```{r rgg-repmesl-eloc, fig.cap = "Integrated metric of local efficiency by session."}
...
```{r rgg-lmerl-eloc, eval = F, results = "asis"}
...
```{r rgg-repmesl-elocw, fig.cap = "Integrated metric of local efficiency (weighted) by session."}
...
```{r rgg-lmerl-elocw, eval = F, results = "asis"}
