...
```{r rgn}
dt.main  <- dt.all[a == "gordon333" & t.m == "raw" & gs == "ngs",
                   -c("a", "t.m", "gs")]
```

### Acute phase

```{r rgn-sparklines-acute, fig.cap = "Sparklines of the topology metrics across thresholds. Labels: Max and Min; Grey shadow: IQR.", fig.height = 9}
...
```{r rgn-repmes-density, fig.cap = "Integrated metric of density by group."}
...
```{r rgn-lmer-density, results = "asis"}
...
```{r rgn-repmes-strength, fig.cap = "Integrated metric of strength by group."}
...
```{r rgn-lmer-strength, results = "asis"}
...
```{r rgn-repmes-mod, fig.cap = "Integrated metric of modularity by group."}
mod2x2 <- dt.integrals[,
...
```{r rgn-repmes-nhubs, fig.cap = "Integrated metric of the number of hubs by group."}
...
```{r rgn-repmes-eglob, fig.cap = "Integrated metric of global efficiency by group."}
...
```{r rgn-repmes-eglobw, fig.cap = "Integrated metric of global efficiency by group (weighted)."}
...
```{r rgn-lmer-eglobw, results = "asis"}
...
```{r rgn-repmes-eloc, fig.cap = "Integrated metric of local efficiency by group."}
...
```{r rgn-repmes-elocw, fig.cap = "Integrated metric of local efficicency (weighted) by group."}
...
```{r rgn-sparklines-long, fig.cap = "Sparklines of the topology metrics across thresholds in the maintenance phase. Labels: Max and Min; Grey shadow: IQR.", fig.height = 9}
# Reshape to Long
columns <- c(dems, "t", metrics)
...
```{r rgn-repmesl-density, fig.cap = "Integrated metric of density by session."}
...
```{r rgn-lmerl-density, eval = F, results = "asis"}
...
```{r rgn-repmesl-strength, fig.cap = "Integrated metric of strength by session."}
...
```{r rgn-lmerl-strength, eval = F, results = "asis"}
...
```{r rgn-repmesl-mod, fig.cap = "Integrated metric of modularity by session."}
...
```{r rgn-lmerl-mod, eval = F, results = "asis"}
...
```{r rgn-repmesl-hubs, fig.cap = "Integrated metric of number of hubs by session."}
...
```{r rgn-lmerl-nhubs, eval = F, results = "asis"}
...
```{r rgn-repmesl-eglob, fig.cap = "Integrated metric of global efficiency by session."}
...
```{r rgn-lmerl-eglob, eval = F, results = "asis"}
...
```{r rgn-repmesl-eglobw, fig.cap = "Integrated metric of global efficiency (weighted) by session."}
...
```{r rgn-lmerl-eglobw, eval = F, results = "asis"}
...
```{r rgn-repmesl-eloc, fig.cap = "Integrated metric of local efficiency by session."}
...
```{r rgn-lmerl-eloc, eval = F, results = "asis"}
...
```{r rgn-repmesl-elocw, fig.cap = "Integrated metric of local efficiency (weighted) by session."}
...
```{r rgn-lmerl-elocw, eval = F, results = "asis"}
