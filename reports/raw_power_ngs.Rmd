...
```{r rpn}
dt.main  <- dt.all[a == "power264" & t.m == "raw" & gs == "ngs",
                   -c("a", "t.m", "gs")]
```

### Acute phase

```{r rpn-sparklines-acute, fig.cap = "Sparklines of the topology metrics across thresholds. Labels: Max and Min; Grey shadow: IQR.", fig.height = 9}
...
```{r rpn-repmes-density, fig.cap = "Integrated metric of density by group."}
...
```{r rpn-lmer-density, results = "asis"}
...
```{r rpn-repmes-strength, fig.cap = "Integrated metric of strength by group."}
...
```{r rpn-lmer-strength, results = "asis"}
...
```{r rpn-repmes-mod, fig.cap = "Integrated metric of modularity by group."}
mod2x2 <- dt.integrals[,
...
```{r rpn-repmes-nhubs, fig.cap = "Integrated metric of the number of hubs by group."}
...
```{r rpn-repmes-eglob, fig.cap = "Integrated metric of global efficiency by group."}
...
```{r rpn-repmes-eglobw, fig.cap = "Integrated metric of global efficiency by group (weighted)."}
...
```{r rpn-lmer-eglobw, results = "asis"}
...
```{r rpn-repmes-eloc, fig.cap = "Integrated metric of local efficiency by group."}
...
```{r rpn-repmes-elocw, fig.cap = "Integrated metric of local efficicency (weighted) by group."}
...
```{r rpn-sparklines-long, fig.cap = "Sparklines of the topology metrics across thresholds in the maintenance phase. Labels: Max and Min; Grey shadow: IQR.", fig.height = 9}
# Reshape to Long
columns <- c(dems, "t", metrics)
...
```{r rpn-repmesl-density, fig.cap = "Integrated metric of density by session."}
...
```{r rpn-lmerl-density, eval = F, results = "asis"}
...
```{r rpn-repmesl-strength, fig.cap = "Integrated metric of strength by session."}
...
```{r rpn-lmerl-strength, eval = F, results = "asis"}
...
```{r rpn-repmesl-mod, fig.cap = "Integrated metric of modularity by session."}
...
```{r rpn-lmerl-mod, eval = F, results = "asis"}
...
```{r rpn-repmesl-hubs, fig.cap = "Integrated metric of number of hubs by session."}
...
```{r rpn-lmerl-nhubs, eval = F, results = "asis"}
...
```{r rpn-repmesl-eglob, fig.cap = "Integrated metric of global efficiency by session."}
...
```{r rpn-lmerl-eglob, eval = F, results = "asis"}
...
```{r rpn-repmesl-eglobw, fig.cap = "Integrated metric of global efficiency (weighted) by session."}
...
```{r rpn-lmerl-eglobw, eval = F, results = "asis"}
...
```{r rpn-repmesl-eloc, fig.cap = "Integrated metric of local efficiency by session."}
...
```{r rpn-lmerl-eloc, eval = F, results = "asis"}
...
```{r rpn-repmesl-elocw, fig.cap = "Integrated metric of local efficiency (weighted) by session."}
...
```{r rpn-lmerl-elocw, eval = F, results = "asis"}
