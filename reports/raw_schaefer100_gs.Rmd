...
```{r rs1g}
dt.main  <- dt.all[a == "schaefer100x7" & t.m == "raw" & gs == "gs",
                   -c("a", "t.m", "gs")]
```

### Acute phase

```{r rs1g-sparklines-acute, fig.cap = "Sparklines of the topology metrics across thresholds. Labels: Max and Min; Grey shadow: IQR.", fig.height = 9}
...
```{r rs1g-repmes-density, fig.cap = "Integrated metric of density by group."}
...
```{r rs1g-lmer-density, results = "asis"}
...
```{r rs1g-repmes-strength, fig.cap = "Integrated metric of strength by group."}
...
```{r rs1g-lmer-strength, results = "asis"}
...
```{r rs1g-repmes-mod, fig.cap = "Integrated metric of modularity by group."}
mod2x2 <- dt.integrals[,
...
```{r rs1g-repmes-nhubs, fig.cap = "Integrated metric of the number of hubs by group."}
...
```{r rs1g-lmer-nhubs, results = 'asis'}
...
```{r rs1g-repmes-eglob, fig.cap = "Integrated metric of global efficiency by group."}
...
```{r rs1g-lmer-eglob, results = "asis"}
...
```{r rs1g-repmes-eglobw, fig.cap = "Integrated metric of global efficiency by group (weighted)."}
...
```{r rs1g-lmer-eglobw, results = "asis"}
...
```{r rs1g-repmes-eloc, fig.cap = "Integrated metric of local efficiency by group."}
...
```{r rs1g-repmes-elocw, fig.cap = "Integrated metric of local efficicency (weighted) by group."}
...
```{r rs1g-lmer-elocw, results= "asis"}
...
```{r rs1g-sparklines-long, fig.cap = "Sparklines of the topology metrics across thresholds in the maintenance phase. Labels: Max and Min; Grey shadow: IQR.", fig.height = 9}
#Reshape to Long
columns <- c(dems, "t", metrics)
...
```{r rs1g-repmesl-density, fig.cap = "Integrated metric of density by session."}
...
```{r rs1g-lmerl-density, eval = F, results = "asis"}
...
```{r rs1g-repmesl-strength, fig.cap = "Integrated metric of strength by session."}
...
```{r rs1g-lmerl-strength, eval = F, results = "asis"}
...
```{r rs1g-repmesl-mod, fig.cap = "Integrated metric of modularity by session."}
...
```{r rs1g-lmerl-mod, eval = F, results = "asis"}
...
```{r rs1g-repmesl-hubs, fig.cap = "Integrated metric of number of hubs by session."}
...
```{r rs1g-lmerl-nhubs, eval = F, results = "asis"}
...
```{r rs1g-repmesl-eglob, fig.cap = "Integrated metric of global efficiency by session."}
...
```{r rs1g-lmerl-eglob, eval = F, results = "asis"}
...
```{r rs1g-repmesl-eglobw, fig.cap = "Integrated metric of global efficiency (weighted) by session."}
...
```{r rs1g-lmerl-eglobw, eval = F, results = "asis"}
...
```{r rs1g-repmesl-eloc, fig.cap = "Integrated metric of local efficiency by session."}
...
```{r rs1g-lmerl-eloc, eval = F, results = "asis"}
...
```{r rs1g-repmesl-elocw, fig.cap = "Integrated metric of local efficiency (weighted) by session."}
...
```{r rs1g-lmerl-elocw, eval = F, results = "asis"}
