...
```{r rs1n}
dt.main  <- dt.all[a == "schaefer100x7" & t.m == "raw" & gs == "ngs",
                   -c("a", "t.m", "gs")]
```

### Acute phase

```{r rs1n-sparklines-acute, fig.cap = "Sparklines of the topology metrics across thresholds. Labels: Max and Min; Grey shadow: IQR.", fig.height = 9}
...
```{r rs1n-repmes-density, fig.cap = "Integrated metric of density by group."}
...
```{r rs1n-lmer-density, results = "asis"}
...
```{r rs1n-repmes-strength, fig.cap = "Integrated metric of strength by group."}
...
```{r rs1n-lmer-strength, results = "asis"}
...
```{r rs1n-repmes-mod, fig.cap = "Integrated metric of modularity by group."}
mod2x2 <- dt.integrals[,
...
```{r rs1n-repmes-nhubs, fig.cap = "Integrated metric of the number of hubs by group."}
...
```{r rs1n-lmer-nhubs, results = 'asis'}
...
```{r rs1n-repmes-eglob, fig.cap = "Integrated metric of global efficiency by group."}
...
```{r rs1n-lmer-eglob, results = "asis"}
...
```{r rs1n-repmes-eglobw, fig.cap = "Integrated metric of global efficiency by group (weighted)."}
...
```{r rs1n-lmer-eglobw, results = "asis"}
...
```{r rs1n-repmes-eloc, fig.cap = "Integrated metric of local efficiency by group."}
...
```{r rs1n-repmes-elocw, fig.cap = "Integrated metric of local efficicency (weighted) by group."}
...
```{r rs1n-lmer-elocw, results= "asis"}
...
```{r rs1n-sparklines-long, fig.cap = "Sparklines of the topology metrics across thresholds in the maintenance phase. Labels: Max and Min; Grey shadow: IQR.", fig.height = 9}
# Reshape to Long
columns <- c(dems, "t", metrics)
...
```{r rs1n-repmesl-density, fig.cap = "Integrated metric of density by session."}
...
```{r rs1n-lmerl-density, eval = F, results = "asis"}
...
```{r rs1n-repmesl-strength, fig.cap = "Integrated metric of strength by session."}
...
```{r rs1n-lmerl-strength, eval = F, results = "asis"}
...
```{r rs1n-repmesl-mod, fig.cap = "Integrated metric of modularity by session."}
...
```{r rs1n-lmerl-mod, eval = F, results = "asis"}
...
```{r rs1n-repmesl-hubs, fig.cap = "Integrated metric of number of hubs by session."}
...
```{r rs1n-lmerl-nhubs, eval = F, results = "asis"}
...
```{r rs1n-repmesl-eglob, fig.cap = "Integrated metric of global efficiency by session."}
...
```{r rs1n-lmerl-eglob, eval = F, results = "asis"}
...
```{r rs1n-repmesl-eglobw, fig.cap = "Integrated metric of global efficiency (weighted) by session."}
...
```{r rs1n-lmerl-eglobw, eval = F, results = "asis"}
...
```{r rs1n-repmesl-eloc, fig.cap = "Integrated metric of local efficiency by session."}
...
```{r rs1n-lmerl-eloc, eval = F, results = "asis"}
...
```{r rs1n-repmesl-elocw, fig.cap = "Integrated metric of local efficiency (weighted) by session."}
...
```{r rs1n-lmerl-elocw, eval = F, results = "asis"}
