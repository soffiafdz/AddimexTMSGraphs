...
```{r rs2g}
dt.main  <- dt.all[a == "schaefer200x7" & t.m == "raw" & gs == "gs",
                   -c("a", "t.m", "gs")]
```

### Acute phase

```{r rs2g-sparklines-acute, fig.cap = "Sparklines of the topology metrics across thresholds. Labels: Max and Min; Grey shadow: IQR.", fig.height = 9}
...
```{r rs2g-repmes-density, fig.cap = "Integrated metric of density by group."}
...
```{r rs2g-lmer-density, results = "asis"}
...
```{r rs2g-repmes-strength, fig.cap = "Integrated metric of strength by group."}
...
```{r rs2g-lmer-strength, results = "asis"}
...
```{r rs2g-repmes-mod, fig.cap = "Integrated metric of modularity by group."}
mod2x2 <- dt.integrals[,
...
```{r rs2g-repmes-nhubs, fig.cap = "Integrated metric of the number of hubs by group."}
...
```{r rs2g-lmer-nhubs, results = 'asis'}
...
```{r rs2g-repmes-eglob, fig.cap = "Integrated metric of global efficiency by group."}
...
```{r rs2g-lmer-eglob, results = "asis"}
...
```{r rs2g-repmes-eglobw, fig.cap = "Integrated metric of global efficiency by group (weighted)."}
...
```{r rs2g-lmer-eglobw, results = "asis"}
...
```{r rs2g-repmes-eloc, fig.cap = "Integrated metric of local efficiency by group."}
...
```{r rs2g-repmes-elocw, fig.cap = "Integrated metric of local efficicency (weighted) by group."}
...
```{r rs2g-lmer-elocw, results= "asis"}
...
```{r rs2g-sparklines-long, fig.cap = "Sparklines of the topology metrics across thresholds in the maintenance phase. Labels: Max and Min; Grey shadow: IQR.", fig.height = 9}
#Reshape to Long
columns <- c(dems, "t", metrics)
...
```{r rs2g-repmesl-density, fig.cap = "Integrated metric of density by session."}
...
```{r rs2g-lmerl-density, eval = F, results = "asis"}
...
```{r rs2g-repmesl-strength, fig.cap = "Integrated metric of strength by session."}
...
```{r rs2g-lmerl-strength, eval = F, results = "asis"}
...
```{r rs2g-repmesl-mod, fig.cap = "Integrated metric of modularity by session."}
...
```{r rs2g-lmerl-mod, eval = F, results = "asis"}
...
```{r rs2g-repmesl-hubs, fig.cap = "Integrated metric of number of hubs by session."}
...
```{r rs2g-lmerl-nhubs, eval = F, results = "asis"}
...
```{r rs2g-repmesl-eglob, fig.cap = "Integrated metric of global efficiency by session."}
...
```{r rs2g-lmerl-eglob, eval = F, results = "asis"}
...
```{r rs2g-repmesl-eglobw, fig.cap = "Integrated metric of global efficiency (weighted) by session."}
...
```{r rs2g-lmerl-eglobw, eval = F, results = "asis"}
...
```{r rs2g-repmesl-eloc, fig.cap = "Integrated metric of local efficiency by session."}
...
```{r rs2g-lmerl-eloc, eval = F, results = "asis"}
...
```{r rs2g-repmesl-elocw, fig.cap = "Integrated metric of local efficiency (weighted) by session."}
...
```{r rs2g-lmerl-elocw, eval = F, results = "asis"}
