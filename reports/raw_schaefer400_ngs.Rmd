...
```{r rs4n}
dt.main  <- dt.all[a == "schaefer400x7" & t.m == "raw" & gs == "ngs",
                   -c("a", "t.m", "gs")]
```

### Acute phase

```{r rs4n-sparklines-acute, fig.cap = "Sparklines of the topology metrics across thresholds. Labels: Max and Min; Grey shadow: IQR.", fig.height = 9}
...
```{r rs4n-repmes-density, fig.cap = "Integrated metric of density by group."}
...
```{r rs4n-lmer-density, results = "asis"}
...
```{r rs4n-repmes-strength, fig.cap = "Integrated metric of strength by group."}
...
```{r rs4n-lmer-strength, results = "asis"}
...
```{r rs4n-repmes-mod, fig.cap = "Integrated metric of modularity by group."}
mod2x2 <- dt.integrals[,
...
```{r rs4n-repmes-nhubs, fig.cap = "Integrated metric of the number of hubs by group."}
...
```{r rs4n-lmer-nhubs, results = 'asis'}
...
```{r rs4n-repmes-eglob, fig.cap = "Integrated metric of global efficiency by group."}
...
```{r rs4n-lmer-eglob, results = "asis"}
...
```{r rs4n-repmes-eglobw, fig.cap = "Integrated metric of global efficiency by group (weighted)."}
...
```{r rs4n-lmer-eglobw, results = "asis"}
...
```{r rs4n-repmes-eloc, fig.cap = "Integrated metric of local efficiency by group."}
...
```{r rs4n-repmes-elocw, fig.cap = "Integrated metric of local efficicency (weighted) by group."}
...
```{r rs4n-lmer-elocw, results= "asis"}
...
```{r rs4n-sparklines-long, fig.cap = "Sparklines of the topology metrics across thresholds in the maintenance phase. Labels: Max and Min; Grey shadow: IQR.", fig.height = 9}
# Reshape to Long
columns <- c(dems, "t", metrics)
...
```{r rs4n-repmesl-density, fig.cap = "Integrated metric of density by session."}
...
```{r rs4n-lmerl-density, eval = F, results = "asis"}
...
```{r rs4n-repmesl-strength, fig.cap = "Integrated metric of strength by session."}
...
```{r rs4n-lmerl-strength, eval = F, results = "asis"}
...
```{r rs4n-repmesl-mod, fig.cap = "Integrated metric of modularity by session."}
...
```{r rs4n-lmerl-mod, eval = F, results = "asis"}
...
```{r rs4n-repmesl-hubs, fig.cap = "Integrated metric of number of hubs by session."}
...
```{r rs4n-lmerl-nhubs, eval = F, results = "asis"}
...
```{r rs4n-repmesl-eglob, fig.cap = "Integrated metric of global efficiency by session."}
...
```{r rs4n-lmerl-eglob, eval = F, results = "asis"}
...
```{r rs4n-repmesl-eglobw, fig.cap = "Integrated metric of global efficiency (weighted) by session."}
...
```{r rs4n-lmerl-eglobw, eval = F, results = "asis"}
...
```{r rs4n-repmesl-eloc, fig.cap = "Integrated metric of local efficiency by session."}
...
```{r rs4n-lmerl-eloc, eval = F, results = "asis"}
...
```{r rs4n-repmesl-elocw, fig.cap = "Integrated metric of local efficiency (weighted) by session."}
...
```{r rs4n-lmerl-elocw, eval = F, results = "asis"}
