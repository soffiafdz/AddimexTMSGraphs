...
randNetsP <- read_rds('outData/graphs/20190910_randNetsP.RDS')

richP <- na.omit(randNetsP$rich)
smallP <- randNetsP$small[, threshold := thresholds[threshold]]
...
smallT0 <- randNetsT0$small[, `:=`(
    Stage = rep.int('T0', nrow(randNetsT0$small)),
...
smallT1 <- randNetsT1$small[, `:=`(
    Stage = rep.int('T1', nrow(randNetsT1$small)),
    threshold = thresholds[threshold]
)]
...
randNetsL10 <- read_rds('outData/graphs/20190910_randNetsL10.RDS')

richL10 <- na.omit(randNetsL10$rich)
smallL10 <- randNetsL10$small[, `:=`(
    Stage = rep.int('T0', nrow(randNetsL10$small)),
    threshold = thresholds[threshold]
)]
...
randNetsL11 <- read_rds('outData/graphs/20190910_randNetsL11.RDS')

richL11 <- na.omit(randNetsL11$rich)
smallL11 <- randNetsL11$small[, `:=`(
    Stage = rep.int('T1', nrow(randNetsL11$small)),
    threshold = thresholds[threshold]
)]
...
smallL12 <- randNetsL12$small[, `:=`(
    Stage = rep.int('T2', nrow(randNetsL12$small)),
    threshold = thresholds[threshold]
)]
...
smallL20 <- randNetsL20$small[, `:=`(
    Stage = rep.int('T0', nrow(randNetsL20$small)),
    threshold = thresholds[threshold]
)]
...
smallL21 <- randNetsL21$small[, `:=`(
    Stage = rep.int('T1', nrow(randNetsL21$small)),
    threshold = thresholds[threshold]
)]
...
smallL22 <- randNetsL22$small[, `:=`(
    Stage = rep.int('T2', nrow(randNetsL22$small)),
    threshold = thresholds[threshold]
)]
...
smallL23 <- randNetsL23$small[, `:=`(
    Stage = rep.int('T3', nrow(randNetsL23$small)),
    threshold = thresholds[threshold]
)]
...
swT <- rbindlist(list(smallT0, smallT1))
swL1 <- rbindlist(list(smallL10, smallL11, smallL12))
swL2 <- rbindlist(list(smallL20, smallL21, smallL22, smallL23))
